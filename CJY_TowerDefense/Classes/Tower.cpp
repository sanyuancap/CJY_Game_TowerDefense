...
Tower* Tower::nodeWithTheGame(HelloWorld *game, cocos2d::CCPoint location){
...
bool Tower::initWithTheGame(HelloWorld *game, cocos2d::CCPoint location){
...
void Tower::removeBullet(cocos2d::CCSprite *bullet){
